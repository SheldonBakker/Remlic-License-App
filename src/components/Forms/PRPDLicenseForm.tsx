...
interface PRPDLicenseFormProps {
  onClose: () => void;
  editingLicense?: any;
}

const PRPDLicenseForm: React.FC<PRPDLicenseFormProps> = ({ onClose, editingLicense }) => {
  ...
  return (
    <>
      <div className="bg-[#1f2937]/40 backdrop-blur-2xl rounded-2xl p-6 sm:p-8 border border-indigo-500/30
        ...
        <div className="mb-6">
          ...
          <Typography variant="body1" className="text-white/60 text-base">
            Please fill in your PRPD license details below
          </Typography>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full p-3 bg-[#1f2937]/60 border rounded-lg text-white 
                  ...
                  ${formErrors.firstName ? 'border-red-500' : 'border-indigo-500/30'}`}
                maxLength={100}
                required
              />
      ...
      {showSuccessModal && (
        <SuccessModal
          title="Success!"
          message={`PRPD License ${editingLicense ? 'updated' : 'added'} successfully`}
          onClose={() => {
...
export default PRPDLicenseForm; 