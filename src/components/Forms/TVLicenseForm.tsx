...
interface TVLicenseFormProps {
  onClose: () => void;
  editingLicense?: any;
}

const TVLicenseForm: React.FC<TVLicenseFormProps> = ({ onClose, editingLicense }) => {
  ...
  return (
    <>
      ...
      {showSuccessModal && (
        <SuccessModal
          title="Success!"
          message={`TV License ${editingLicense ? 'updated' : 'added'} successfully`}
          onClose={() => {
