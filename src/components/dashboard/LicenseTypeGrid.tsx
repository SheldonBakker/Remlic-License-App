...
export const LicenseTypeGrid: React.FC<LicenseTypeGridProps> = ({
  licenses,
  selectedSection,
  onSectionSelect,
  userTier,
          ...
          <div
            ...
            className={`
              ...
              ${selectedSection === type 
                ? 'border-indigo-400 bg-gradient-to-br from-indigo-500/20 to-indigo-500/5' 
